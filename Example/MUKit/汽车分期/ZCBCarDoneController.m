...
#import "ZCBCarDoneController.h"
#import "ZCBCarDoneHeaderView.h"

@interface ZCBCarDoneController ()

@property(nonatomic, strong)ZCBCarDoneHeaderView *headerView;
@end

@implementation ZCBCarDoneController

- (void)viewDidLoad {
    [super viewDidLoad];
    
//    [self TTTitle:@"申请装修金贷款" textColor:[UIColor whiteColor] isShimmering:NO];
//    self.headerView = [ZCBCarDoneHeaderView ViewFromXib];
