//
//  ZCBCarRealEstateInfomationController.m
//  MUKit_Example
//
...
#import "ZCBCarRealEstateInfomationController.h"
#import "ZCBCarRealEstateInfomationHeaderView.h"
//#import "AreaView.h"
//#import "AddressAreaModel.h"
//#import "ZCBCommonAddressView.h"


@interface ZCBCarRealEstateInfomationController ()
//<AreaSelectDelegate>
...
@property(nonatomic, strong)ZCBCarRealEstateInfomationHeaderView *headerView;
...
@implementation ZCBCarRealEstateInfomationController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.ids = [NSMutableArray array];
//    [self TTTitle:@"申请装修金贷款" textColor:[UIColor whiteColor] isShimmering:NO];
//    self.headerView = [ZCBCarRealEstateInfomationHeaderView ViewFromXib];
...
//        });
        ...
        if ([responseObject[@"status"] integerValue] ==1)
        {
            ...
            if (self.decorationImageArray.count >0&& self.houseImageArray.count >0) {
                ...
                [self.navigationController WillPushViewController:@"ZCBCarPersonalInfomationController" animated:YES SetupParms:^(UIViewController *vc, NSMutableDictionary *dict) {
