...
#import "ZCBCarMoneyDoneController.h"
#import "ZCBCarMoneyDoneHeaderView.h"

@interface ZCBCarMoneyDoneController ()

@property(nonatomic, strong)ZCBCarMoneyDoneHeaderView *headerView;
@end

@implementation ZCBCarMoneyDoneController

- (void)viewDidLoad {
    [super viewDidLoad];
//    [self TTTitle:@"我的装修金完成" textColor:[UIColor whiteColor] isShimmering:NO];
//    self.headerView = [ZCBCarMoneyDoneHeaderView ViewFromXib];
