//
//  MUTextKitRenderer+Positioning.h
//  MUAsyncDisplayLayer
//
...
typedef void (^mu_text_component_index_block_t)(NSUInteger characterIndex,
 ...
 */
typedef NS_ENUM(NSUInteger, MUTextKitRendererMeasureOption) {
    MUTextKitRendererMeasureOptionLineHeight,
    MUTextKitRendererMeasureOptionCapHeight,
    MUTextKitRendererMeasureOptionBlock
};

@interface MUTextKitRenderer (Positioning)
...
- (void)enumerateTextIndexesAtPosition:(CGPoint)position
                            usingBlock:(mu_text_component_index_block_t)block;
