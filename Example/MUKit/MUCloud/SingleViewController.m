...
//    [FlyImageCache sharedInstance].autoDismissImage = YES;
	...
	// add // remove // clear
	CGFloat fromY = self.view.bounds.size.height - 200 - self.navigationBarAndStatusBarHeight;
...
- (void)onAddImageView {
	...
	for (NSInteger i=0; i<4; i++) {
		...
		NSString *url = [NSString stringWithFormat:@"http://liuliantv.oss-cn-beijing.aliyuncs.com/flyimage/%ld.jpg", (long)index];
