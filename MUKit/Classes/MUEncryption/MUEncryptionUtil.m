...
@implementation MUEncryptionUtil
...
//使用公钥字符串加密
+ (NSString *)RSAEncryMU:(NSString *)str publicKey:(NSString *)pubKey{
...
//使用私钥字符串解密
+ (NSString *)RSADecryMU:(NSString *)str privateKey:(NSString *)privKey{
    if (!str) return nil;
    NSData *data = [[NSData alloc] initWithBase64EncodedString:str options:NSDataBase64DecodingIgnoreUnknownCharacters];
