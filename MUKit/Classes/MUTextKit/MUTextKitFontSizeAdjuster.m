...
@implementation MUTextKitFontSizeAdjuster{
   __weak MUTextKitAttribute *_attributes;
   __weak MUTextKitContext *_context;
   NSRecursiveLock *_textKitMutex;
    BOOL _measured;
              ...
              textKitAttributes:(MUTextKitAttribute *)textComponentAttributes;
{
    if (self = [super init]) {
        ...
        _textKitMutex = [[NSRecursiveLock alloc]init];
    }
    return self;
}
...
- (NSUInteger)lineCountForString:(NSAttributedString *)attributedString
{
    ...
    if (_sizingLayoutManager == nil) {
        _sizingLayoutManager = [[MUTextLayoutManager alloc] init];
